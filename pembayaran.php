        ...
        <div class="row justify-content-center">
            <div class="card">
                <div class="card-header">Kembalian</div>
                    ...
                    <br>
                    <a href="formbook.php"><button type="submit" class="btn btn-outline-primary">Lagi</button></a> 
                    <form action="" method="get" class="form-group">                  
                    <button type="submit" class="btn btn-outline-primary" name="udah">Cukup</button>
                    <?php 
                    if (isset($_GET['udah'])) {
                        echo "<br>";
                        echo "Terima kasih :)";
